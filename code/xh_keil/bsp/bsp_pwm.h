...
#define AUX_SW_PWM_UNIT  HRPWM_SW_SYNC_UNIT6

#define HRPWM_PWM_FCG        (FCG2_PERIPH_HRPWM_1 | FCG2_PERIPH_HRPWM_2 | FCG2_PERIPH_HRPWM_3 | FCG2_PERIPH_HRPWM_4 | FCG2_PERIPH_HRPWM_5 | FCG2_PERIPH_HRPWM_6)
