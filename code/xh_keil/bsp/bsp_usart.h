...
extern uint8_t USART3_Txbuff[Usart3_TxBuff_Size];
extern uint8_t USART3_Rxbuff[Usart3_RxBuff_Size];
extern volatile uint8_t usart3_rx_buffer[Usart3_RxBuff_Size];
...
extern uint16_t  Usart3_Rx_Lenth ; //接收长度
...
void USART3_RxTimeout_config(void);
