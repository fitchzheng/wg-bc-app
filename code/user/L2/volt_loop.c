...
#define VOLT_LOOP_SIN_70       (0.939692621f)
#define VOLT_LOOP_TAN_70       (2.747477419f)
...
void volt_loop_init(volt_loop_t *volt_loop)
{
    ...
    volt_loop->inter.pid.cfg.kp = VOLT_LOOP_SIN_70 * volt_loop->cfg.w_cut * volt_loop->cfg.c_val;
    volt_loop->inter.pid.cfg.ki = volt_loop->cfg.w_cut * volt_loop->inter.pid.cfg.kp / VOLT_LOOP_TAN_70 / volt_loop->cfg.freq_ctrl;
