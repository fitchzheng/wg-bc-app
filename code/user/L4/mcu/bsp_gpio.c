...
const bsp_gpio_parm_t bsp_gpio_parm_table[] = {
    GPIO_REG_PARM(AUXOFF, GPIOC, 13, OUT_PP, 1),
    GPIO_REG_PARM(RED, GPIOB, 12, OUT_PP, 0),
    GPIO_REG_PARM(Green, GPIOB, 15, OUT_PP, 0),
    GPIO_REG_PARM(BLED1, GPIOC, 8, OUT_PP, 0),
    GPIO_REG_PARM(BLED2, GPIOC, 9, OUT_PP, 0),
    GPIO_REG_PARM(LEDS, GPIOA, 12, OUT_PP, 0),
    GPIO_REG_PARM(PG_EN, GPIOA, 15, IPD, 0),
    GPIO_REG_PARM(DB2, GPIOC, 12, OUT_PP, 0),
    GPIO_REG_PARM(DB1, GPIOD, 2, OUT_PP, 0),
    GPIO_REG_PARM(DA2, GPIOB, 3, OUT_PP, 0),
    GPIO_REG_PARM(DA1, GPIOB, 4, OUT_PP, 0),
    GPIO_REG_PARM(RE, GPIOB, 5, OUT_PP, 0),
    GPIO_REG_PARM(TEST_PC5, GPIOC, 5, OUT_PP, 0),
};
...
void bsp_gpio_init(void)
{
    ...
    for (i = 0; i < gpio_num; i++)
    {
        ...
        gpio_bit_write(bsp_gpio_parm_table[i].gpio_periph,
